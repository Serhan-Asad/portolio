        ...
        <div className=" relative pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          ...
          {url && (
            <Link href={url} passHref>
              <button className="mt-7 absolute top-1 right-10 text-[0.8rem] cursor-pointer bg-blue-500  text-white font-semibold py-2 px-4 rounded-full  transition dark:text-white/70">Visit </button>
            </Link>
          )}
          </div>

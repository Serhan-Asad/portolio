...
import picture from "@/public/headShot.jpeg"
...
/>
          ...
          <motion.span
            className="absolute bottom-1 right-5 text-5xl"
            initial={{ opacity: 0, scale: 0 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{
              type: "spring",
  ...
  Hello there! I'm <span className="text-indigo-600">Serhan Asad</span> a Georgia Tech Computer Science student. I'm passionate about AI for materials discovery, web development, and data analytics, committed to innovation and user-focused solutions.
      ...
      >
        <Link
          href="#contact"
          className="group bg-gray-900 text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 transition mr-4"
          onClick={() => {
        ...
        <a
          ...
          href="https://www.linkedin.com/in/serhan-asad/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/Serhan-Asad"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
